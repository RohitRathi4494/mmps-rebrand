...
export const AnimatedTestimonials: React.FC<AnimatedTestimonialsProps> = ({
  ...
  useEffect(() => {
    // Reset active index if testimonials list changes and current index is out of bounds
            ...
            <div className="relative h-80 w-full max-w-xs">
              <AnimatePresence>
                {testimonials.map((testimonial, index) => (
                  <motion.div
                    key={testimonial.src + index} // Added index to key to handle duplicate images if necessary
